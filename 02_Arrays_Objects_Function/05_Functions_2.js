...
// let and const are block scope and is only accessible where they are declared inside { } 
// while var is a function scope and it can be accessed from anywhere inside the function.
...
// Rest Parameters inside a function
//---------------------------------------------
...
console.log(Ans); // this will print whole function return by myFuncs()-> hello( )
Ans(); // this will print all the statements inside a return function.
